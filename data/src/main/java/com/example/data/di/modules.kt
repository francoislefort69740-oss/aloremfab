...
import com.example.data.database.repository.ControlGRVStep5LocalDataSourceImpl
import com.example.data.database.repository.ControlGRVStep6LocalDataSource
import com.example.data.database.repository.ControlGRVStep6LocalDataSourceImpl
...
val dataModule = module {
    ...
    factory { get<MyDatabase>().controlGRVStep5Dao() }
    factory { get<MyDatabase>().controlGRVStep6Dao() }
    ...
    factory<ControlGRVStep5LocalDataSource> { ControlGRVStep5LocalDataSourceImpl(get()) }
    factory<ControlGRVStep6LocalDataSource> { ControlGRVStep6LocalDataSourceImpl(get()) }
